...
export default function PromptFlowStep1({ setCurrentStep }: { currentStep: number; setCurrentStep: React.Dispatch<React.SetStateAction<number>> }) {
  ...
  return (
    <>
      ...
      <div className="flex flex-col border mx-3 rounded-2xl py-2">
      ...
      <DialogFooter className="mx-4 mt-4">
        <Button className="font-normal" onClick={() => setCurrentStep(2)}>
          Next
        </Button>
      </DialogFooter>
    </>
