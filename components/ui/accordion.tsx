  ...
  return (
    <AccordionPrimitive.Header className="flex">
      ...
      >
        ...
        <ChevronDownIcon className="text-muted-foreground pointer-events-none size-4 shrink-0 translate-y-0.5 transition-transform duration-200 relative after:absolute after:top-0 after:left-0 after:size-[25px] after:rounded-full after:bg-[#f5f5f5] after:-z-10 after:block" />
      </AccordionPrimitive.Trigger>
