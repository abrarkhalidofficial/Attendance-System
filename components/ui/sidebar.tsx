  ...
  return (
    <main
      ...
      className={cn(
        ...
        'md:peer-data-[variant=inset]:m-2 md:peer-data-[variant=inset]:ml-0 md:peer-data-[variant=inset]:rounded-xl md:peer-data-[variant=inset]:shadow-sm md:peer-data-[variant=inset]:peer-data-[state=collapsed]:ml-2 pl-0',
        className,
      )}
      {...props}
    />
...
function SidebarMenuButton({
  ...
  return (
    <Tooltip>
      <TooltipTrigger className="in-data-[state=collapsed]:ml-[7px]" asChild>
        {button}
      </TooltipTrigger>
