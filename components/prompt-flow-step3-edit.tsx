...
export default function PromptFlowStep3Edit() {
  ...
  return (
    <>
      ...
      <DialogDescription className="text-foreground">Edit A Source Document</DialogDescription>
      <Separator />
      ...
      <Tabs className="mt-3" defaultValue="voc">
          ...
          <div className="flex gap-3">
            <Popover open={open1} onOpenChange={setOpen1}>
              <PopoverTrigger asChild>
                ...
                >
                  Filter By Category |<span className="text-[10px] font-normal text-primary dark:text-foreground truncate"> {filterButtonText}</span>
                </Button>
              </PopoverTrigger>
